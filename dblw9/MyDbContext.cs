...
namespace dblw9
{
    public class MyDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            Item item2 = new Item { Id = 2, Name = "Apple iPhone 13 128GB nanoSim/eSim Midnight", Unit = "шт", Cost = 59999, SupplierId = apple.Id};
            Item item3 = new Item { Id = 3, Name = "Samsung Galaxy A15 LTE 4/128GB Dark Blue", Unit = "шт", Cost = 14999, SupplierId =  samsung.Id};
            Item item4 = new Item { Id = 4, Name = "HUAWEI nova 12s 8/256GB Black", Unit = "шт", Cost = 27999, SupplierId = huawei.Id};
            Item item5 = new Item { Id = 5, Name = "Xiaomi Redmi Note 13 8/256GB Midnight Black", Unit = "шт", Cost = 20999, SupplierId = xiaomi.Id};
            Item item6 = new Item { Id = 6, Name = "Xiaomi Redmi 12 8/256GB Midnight Black", Unit = "шт", Cost = 12999, SupplierId =  xiaomi.Id};
