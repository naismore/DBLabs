...
namespace dblw9
{
    internal class MyDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Товары
            Item item1 = new Item { Id = 0, Name = "Apple iPhone 15 Pro 128GB Dual Sim Blue Titanium", Unit = "шт", Cost = 109999, SupplierId = apple.Id};
            Item item2 = new Item { Id = 1, Name = "Apple iPhone 13 128GB nanoSim/eSim Midnight", Unit = "шт", Cost = 59999, SupplierId = apple.Id};
            ...
            // Товары на складах
            ItemsInStorage itemsInStorage1 = new ItemsInStorage { Id = 0, ItemId = item1.Id, StorageId = storage1.Id, ArrialDate = DateTime.Now};
